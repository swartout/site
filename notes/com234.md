...
- When in doubt, take the harder option and treat an argument as multiple
- Diagramming:
    - New arguments get a new number
    - Supporting arguments get an extended number
- Diagramming complex arguments:
    1. Read/listen (and note) the piece
    2. Do a draft diagram
        - Mark external evidence
        - Flag implied claims
    3. Refine the draft
    4. TODO
    5. Check the diagram against the original text
        - "Would the author agree with your diagram?"
    6. Polich up the draft and make arguments
...
- Flow:
    - On-case: things brought up by the affirmative, responded by negative
    - Off-case: brought up by negative without responding to affirmative
    - Charting out discussion of different issues by person
    - Flow is a a dynamic report on where time and effort was spent
    - You shoudl be able to "relive" the debate and know who (probably) won
    - It lets you know the clash points
- Resolutions:
    - Typically the main claim in a debate
    - Statement of judgement that identifies the central issue in a controversy
    - Establishes the issues
    - A good one is clear and controversial
- Claim types and topoi:
    - What's the nature of the thing being debated?
    - Topoi are common issues that show up in claim types
- Definition topoi:
    - Is it relevant?
    - Is it fair?
    - How to choose between definitions?
- Value topoi:
    - What values are at issue?
    - How should we judge based on the values?
    - Are there competing considerations?
